        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <a href="#filterModal" data-toggle="modal"> <button type="button" class="btn btn-info">Filter</button></a>
                        <a href="<?php echo site_url('spreadsheet_elastic') ?>" class="btn btn-secondary" role="button">Download Logger Report</a>
                        <a href="<?php echo site_url('summary_data_elastic') ?>" class="btn btn-success" role="button">Elastic Hourly Report</a>
                    </div>
                </div>
            </div>
